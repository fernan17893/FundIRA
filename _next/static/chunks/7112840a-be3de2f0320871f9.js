"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{19:function(t,e,i){i.d(e,{ad:function(){return tl}});var s,r,n,o,h=i(5816),l=i(8463),a=i(3333),u=i(4444),c=i(6640);i(3454),i(8764).lW;let d="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O{constructor(t,e,i,s){this.indexId=t,this.collectionGroup=e,this.fields=i,this.indexState=s}}function F(t){return"IndexedDbTransactionError"===t.name}O.UNKNOWN_ID=-1;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class G{constructor(t){this.binaryString=t}static fromBase64String(t){return new G(function(t){try{return atob(t)}catch(t){throw"undefined"!=typeof DOMException&&t instanceof DOMException?new K("Invalid base64 string: "+t):t}}(t))}static fromUint8Array(t){return new G(function(t){let e="";for(let i=0;i<t.length;++i)e+=String.fromCharCode(t[i]);return e}(t))}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return btoa(this.binaryString)}toUint8Array(){return function(t){let e=new Uint8Array(t.length);for(let i=0;i<t.length;i++)e[i]=t.charCodeAt(i);return e}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return P(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}G.EMPTY_BYTE_STRING=new G("");let j=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function H(t){return"number"==typeof t?t:"string"==typeof t?Number(t):0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class X{constructor(){}ht(t,e){this.Pt(t,e),e.It()}Pt(t,e){var i;if("nullValue"in t)this.Tt(e,5);else if("booleanValue"in t)this.Tt(e,10),e.Et(t.booleanValue?1:0);else if("integerValue"in t)this.Tt(e,15),e.Et(H(t.integerValue));else if("doubleValue"in t){let i=H(t.doubleValue);isNaN(i)?this.Tt(e,13):(this.Tt(e,15),0===i&&1/i==-1/0?e.Et(0):e.Et(i))}else if("timestampValue"in t){let i=t.timestampValue;this.Tt(e,20),"string"==typeof i&&(i=function(t){if(t||T(),"string"==typeof t){let e=0,i=j.exec(t);if(i||T(),i[1]){let t=i[1];e=Number(t=(t+"000000000").substr(0,9))}return{seconds:Math.floor(new Date(t).getTime()/1e3),nanos:e}}return{seconds:H(t.seconds),nanos:H(t.nanos)}}(i)),e.dt(`${i.seconds||""}`),e.Et(i.nanos||0)}else if("stringValue"in t)this.At(t.stringValue,e),this.Rt(e);else if("bytesValue"in t)this.Tt(e,30),e.Vt("string"==typeof(i=t.bytesValue)?G.fromBase64String(i):G.fromUint8Array(i)),this.Rt(e);else if("referenceValue"in t)this.ft(t.referenceValue,e);else if("geoPointValue"in t){let i=t.geoPointValue;this.Tt(e,45),e.Et(i.latitude||0),e.Et(i.longitude||0)}else"mapValue"in t?"__max__"===(((t.mapValue||{}).fields||{}).__type__||{}).stringValue?this.Tt(e,Number.MAX_SAFE_INTEGER):(this.gt(t.mapValue,e),this.Rt(e)):"arrayValue"in t?(this.yt(t.arrayValue,e),this.Rt(e)):T()}At(t,e){this.Tt(e,25),this.wt(t,e)}wt(t,e){e.dt(t)}gt(t,e){let i=t.fields||{};for(let t of(this.Tt(e,55),Object.keys(i)))this.At(t,e),this.Pt(i[t],e)}yt(t,e){let i=t.values||[];for(let t of(this.Tt(e,50),i))this.Pt(t,e)}ft(t,e){this.Tt(e,37),x.fromName(t).path.forEach(t=>{this.Tt(e,60),this.wt(t,e)})}Tt(t,e){t.Et(e)}Rt(t){t.Et(2)}}X.St=new X,new Uint8Array(0);class W{constructor(t,e,i){this.cacheSizeCollectionThreshold=t,this.percentileToCollect=e,this.maximumSequenceNumbersToCollect=i}static withCacheSize(t){return new W(t,W.DEFAULT_COLLECTION_PERCENTILE,W.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}}function J(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
