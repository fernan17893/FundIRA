"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{ET:function(){return sa},IO:function(){return i1},JU:function(){return iN},PL:function(){return ss},QT:function(){return sr},ad:function(){return ib},ar:function(){return i4},hJ:function(){return iA}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(7652);n(357);var d=n(9109).lW;let f="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(e){e=i_(e,iC);let t=i_(e.firestore,iD);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ia({next:s=>{t.enqueueAndForget(()=>rM(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new C(I.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new C(I.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rP(new e4(n.path),s,{includeMetadataChanges:!0,ra:!0});return rL(e,a)})(await id(e),e.asyncQueue,t,n,r)),r.promise})(iR(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new si(e);return new se(e,i,t._key,r,new i7(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class si extends i5{constructor(e){super(),this.firestore=e}convertBytes(e){return new iL(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iC(this.firestore,null,t)}}function ss(e){e=i_(e,iI);let t=i_(e.firestore,iD),n=iR(t),r=new si(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new C(I.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rP(n,new ia({next:n=>{t.enqueueAndForget(()=>rM(e,s)),n.fromCache&&"server"===r.source?i.reject(new C(I.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,ra:!0});return rL(e,s)})(await id(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sn(t,r,e,n)))}function sa(e,t){var n,r;let i=i_(e.firestore,iD),s=iN(e),a=(n=e.converter)?n.toFirestore(t):t;return(r=[(function(e,t,n,r,i,s={}){let a,o;let l=e.Fu(s.merge||s.mergeFields?2:0,t,n,i);iQ("Data must be an object, but it was:",l,r);let u=iK(r,l);if(s.merge)a=new ea(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=(0,h.m9)(t))instanceof iM)return t._internalPath;if("string"==typeof t)return iH(e,t);throw iW("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new C(I.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new ea(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iP(new eL(u),a,o)})(iz(e.firestore),"addDoc",s._key,a,null!==e.converter,{}).toMutation(s._key,tk.exists(!1))],function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>rX(await ic(e).then(e=>e.syncEngine),t,n)),n.promise}(iR(i),r)).then(()=>s)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iD(new D(t.getProvider("auth-internal")),new L(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new C(I.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ey(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(f,"4.6.1",void 0),(0,o.KN)(f,"4.6.1","esm2017")}()}}]);